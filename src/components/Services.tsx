...
const services = [
  { icon: Gem, title: "Custom Jewellery Design", description: "Bring your dream jewellery to life with our bespoke design service tailored to your vision.", image: "/assets/images/SJ b2 1.png" },
  { icon: Paintbrush, title: "Jewellery Restoration", description: "Breathe new life into cherished heirloom pieces with expert restoration services.", image: "/assets/images/SJS e1 1.png" },
  { icon: Wrench, title: "Repair & Resizing", description: "Professional ring resizing, chain repairs, and all types of jewellery restoration.", image: "/assets/images/SJS r1 2.png" },
  { icon: Gift, title: "Bridal Collections", description: "Complete bridal jewellery packages for your special day - necklaces, earrings & more.", image: "/assets/images/SJ w1 1.png" },
  { icon: Scale, title: "Gold & Gem Valuation", description: "Get accurate valuations from certified experts for insurance or resale purposes.", image: "/assets/images/SJ g.jpg" },
  { icon: Truck, title: "Islandwide Service", description: "We serve customers across Sri Lanka. Contact us for arrangements at your convenience.", image: "/assets/images/SJ n6 1.png" },
];
